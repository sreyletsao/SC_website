  ...
  <section class="py-16 bg-white">
    <div class="container mx-auto px-4 max-w-4xl text-gray-700 space-y-6">
      ...
      <p>
        ...
        to provide clean water, scholarship programs, community training, and environmental conservation
        — always in collaboration with local leaders.
      </p>
      <p>
        From a small group of volunteers, we've grown into a trusted non-profit serving over 120 communities
        and supporting more than 2,500 students as of 2024.
      </p>
    </div>
  </section>
</template>
